...
namespace AccCheck
{
    public class LogSystemInformation
    {
        ...
        public struct OperatingSystemConfigStruct
        {
            ...
            public Single DpiX;
            public Single DpiY;
            public Size PrimaryResolutionSize;
        ...
        private void GetSystemInformation(ManagementScope scope)
        {
            ...
            this._operatingSystemConfig.PrimaryResolutionSize = SystemInformation.PrimaryMonitorMaximizedWindowSize;
            ...
            foreach (ManagementObject mo in new ManagementClass(scope, new ManagementPath("Win32_OperatingSystem"), null).GetInstances())
            {
                ...
                _operatingSystem.Name = mo["Name"].ToString().Split("|".ToCharArray())[0];
