...
#pragma warning restore CA2213
        ...
        private void LoadMachines()
        {
            ...
            {
                Common.Log("LoadMachines: Machine Matrix: " + Setting.Values.MachineMatrixString);
        ...
        private void CheckBoxReserseLookup_CheckedChanged(object sender, EventArgs e)
        {
            Setting.Values.ReverseLookup = checkBoxReserseLookup.Checked;
            ShowUpdateMessage();
        }
        ...
        private void LinkLabelReConfigure_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                Common.TelemetryForEvent?.TrackEvent("ReCfg");
