...
namespace MouseWithoutBorders
{
    partial class FrmMatrix
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBoxReserseLookup = new System.Windows.Forms.CheckBox();
            ...
            this.comboBoxSwitchToALLPC.Text = "Ctrl*3";
        ...
        " Enable or Disable)");
            ...
            this.toolTip.SetToolTip(this.checkBoxDrawMouse, "Mouse cursor may not be visible in Windows 8 and later versions of Windows when t" +
        ...
        "g on this machine.");
            ...
            // 
            // checkBoxReserseLookup
            // 
            this.checkBoxReserseLookup.AutoSize = true;
            this.checkBoxReserseLookup.Location = new System.Drawing.Point(9, 141);
            this.checkBoxReserseLookup.Name = "checkBoxReserseLookup";
            this.checkBoxReserseLookup.Size = new System.Drawing.Size(196, 17);
            this.checkBoxReserseLookup.TabIndex = 173;
            this.checkBoxReserseLookup.Text = "&Validate remote machine IP Address";
            this.toolTip.SetToolTip(this.checkBoxReserseLookup, "Reverse DNS lookup to validate machine IP Address (Advanced option, click Help fo" +
        "r any question)");
            this.checkBoxReserseLookup.UseVisualStyleBackColor = true;
            this.checkBoxReserseLookup.CheckedChanged += new System.EventHandler(this.CheckBoxReserseLookup_CheckedChanged);
            // 
            // checkBoxVKMap
            // 
        ...
        "achines have IPv4 enabled)");
            ...
            this.toolTip.SetToolTip(this.checkBoxClipNetStatus, "Show clipboard activities and network status in systen tray notifications");
        ...
        "ard.");
            ...
            this.groupBoxOtherOptions.Controls.Add(this.checkBoxReserseLookup);
    ...
    " name. ";
        ...
        private CheckBox checkBoxReserseLookup;
