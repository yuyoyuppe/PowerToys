...
namespace MouseWithoutBorders
{
    public partial class SettingsForm : System.Windows.Forms.Form
    {
        ...
        public SettingsForm()
        {
            ...
            Common.Log("FIRST RUN, SHOWING THE FIRST SETUP PAGE.");

            Common.Log($"{nameof(Common.RunWithNoAdminRight)} = {Common.RunWithNoAdminRight}");
        ...
        protected override void OnClosing(System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                Common.Log(_currentPage.Name + " closing.");
        ...
        internal void SetControlPage(SettingsFormPage page)
        {
            ...
            if (page != null)
            {
                Common.Log("GOING TO NEXT PAGE: " + page.Name);
