...
namespace localized_strings
{
    ...
    const wchar_t GITHUB_NEW_VERSION_AVAILABLE_TITLE[] = L"New version is available on GitHub!";
    const wchar_t GITHUB_NEW_VERSION_AVAILABLE_OFFER_VISIT[] = L"Would you like to visit its download page?";
...
std::future<void> check_github_updates()
{
    ...
    std::wstring contents = GITHUB_NEW_VERSION_AVAILABLE_TITLE;
    contents += L" (";
    contents += new_version->version_string;
    contents += L")";
    contents += L' ';
    contents += GITHUB_NEW_VERSION_AVAILABLE_OFFER_VISIT;
